...
function embedYoutube(video, target) {
  ...
  if (videoKey) {
    target.innerHTML = `<iframe src="https://www.youtube.com/embed/${videoKey}?autoplay=1&loop=1&controls=0&showinfo=0&autohide=1&rel=0&playlist=PLs3ZGNxRx28jgJ9uuVdvPy2dt6TuXUcyO=1" allowfullscreen=""
